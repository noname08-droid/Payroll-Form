    ...
    <script type="text/javascript">
        function ValidationForm() {
            ...
            if (document.payrollForm.employeeName.value == "") {
                ...
                alert("Data update successfullly!");
            }
...
<body>
    ...
    <form method="post" name="payrollForm">
        <section>
            <div id="group">
                    ...
                    <tr>
                        <th>
                            <div class="form-group">
                                ...
                                <input id="input" style="width:300px;" type="text" class="form-control" name="employeeName" value="">
                            </div>
                            <div class="form-group">
                ...
                <button class="btn btn-dark btn-lg" name="updateBtn" onclick="return ValidationForm()">Update</button>
    ...
    $dbQuery = "UPDATE calculator SET employeeID=$myID, employeeName=UCASE('$employeeName'), position=UCASE('$position'), ratePerHour=$ratePerHour,
    hoursWork='$worked', otPerHour='$OtPerHour', otHour='$otHour', sss='$sss', wtax='$wtax', NetPay='$earnings' WHERE employeeID=$myID";

    if (isset($_POST['updateBtn'])) {
        if ($connection->query($dbQuery) == true) {
            echo ("<p>Data update successfullly on ID: " . $myID . "</p>");
        } else {
